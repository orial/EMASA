...
CREATE TABLE CLIENTE (DNI VARCHAR2(255) NOT NULL, EMAIL VARCHAR2(255) NULL, NOMBRE VARCHAR2(255) NULL, POLIZA NUMBER(10) NULL, TELEFONO NUMBER(10) NULL, PRIMARY KEY (DNI))
